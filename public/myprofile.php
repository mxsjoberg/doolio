...
if ($_POST) {
    include ('../resources/modules/pages/myprofile_.php');
}
            ...
            <div class='container modal-dialog' role='document'>
                <div class='row modal-content'>
                    ...
                    <div class='col-md-12 modal-body'>
                        <div class='col-md-12'><h2 class='no-margin-top'>Add new skill</h2></div>
            ...
            <div class='row modal-content'>
                ...
                <div class='col-md-12 modal-body'>
                    <div class='col-md-12 no-padding'>
                        ...
                        <p class="no-margin margin-top-sm">Here's a reference guide for skill levels, it's best to pick a level based on recent work.
                        </p>
                        <div class="col-md-12 no-padding margin-top-md">
                            <div class="col-md-3 no-padding"><h4 class="no-margin">Beginner</h4></div>
                            <div class="col-md-9 no-padding"><p class="no-margin">You're just starting to explore a skill.</p></div>
                        </div>
                        <div class="col-md-12 no-padding margin-top-md">
                            <div class="col-md-3 no-padding"><h4 class="no-margin">Familiar</h4></div>
                            <div class="col-md-9 no-padding"><p class="no-margin">You have basic knowledge of a skill, but plenty of room to learn more.</p>
                            </div>
                        </div>
                        <div class="col-md-12 no-padding margin-top-md">
                            <div class="col-md-3 no-padding"><h4 class="no-margin">Proficient</h4></div>
                            <div class="col-md-9 no-padding"><p class="no-margin">You're comfortable using a skill in routine ways.</p></div>
                        </div>
                        <div class="col-md-12 no-padding margin-top-md">
                            <div class="col-md-3 no-padding"><h4 class="no-margin">Expert</h4></div>
                            <div class="col-md-9 no-padding"><p class="no-margin">You're fluent in a skill and it's latest developments.</p></div>
                        </div>
                        <div class="col-md-12 no-padding margin-top-md">
                            <div class="col-md-3 no-padding"><h4 class="no-margin">Master</h4></div>
                            <div class="col-md-9 no-padding"><p class="no-margin">You're a pro, and know a skill inside and out.</p></div>
                        </div>
                    </div>
                    <div class='col-md-12 no-padding margin-top-lg border-top-light'>
                        <h2 class='margin-top-lg'>Why include optional links?</h2>
                        <p class="no-margin margin-top-sm">A portfolio, publication, or repository is a great way to prove your skills! Adding references to learning resources could help beginners with their learning, consider using an affiliate link or similar.
                        </p>
                    </div>
