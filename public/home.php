            ...
            <div class="container no-padding">
                <div class="row">
                    ...
                    <div class="col-xs-12 margin-top-xl">
                                    ...
                                    <div class="col-xs-12 col-md-12 no-padding bg-color bg-color-white border-light no-border-radius" style="border: 1px solid #e4e4e4;">
                                        <div class="col-xs-12 col-md-12 border-bottom-light">
                                            <div class="col-xs-12 col-md-12 padding-sm">
                                                <h4 class="no-margin">December 30, 2018</h4>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-12">
                                            <div class="col-xs-12 col-md-12 padding-sm">
                                                <div class="col-xs-12 no-padding">
                                                    <p class="no-margin">We have moved to <a href="https://learnhub.io"><strong>LearnHub.io</strong></a>! Future development will continue there instead and this domain will soon redirect all incoming traffic.</p>
                                                </div>
                                                <div class="col-xs-12 no-padding margin-top-md">
                                                    <p class="no-margin"><a href="https://learnhub.io"><strong>LearnHub.io</strong></a> is a skill tracker with user-curated pathways to make life easier for self-learners. User accounts are not migrated and you are required to sign up again, or explore pathways without an account.</p>
                                                </div>
                                                <div class="col-xs-12 no-padding margin-top-md">
                                                    <p class="no-margin">Thank you and happy new year,</p>
                                                    <p class="no-margin"><em>Michael Sjöberg</em></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <!-- sign in -->
                        <div class="col-md-6 col-xs-12 margin-top-md--sm">
                            <div class="col-xs-12">
                            ...
                            <div class="col-xs-12">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-md-8 col-md-offset-2 no-padding center">
                                        <a href="https://learnhub.io" class="btn btn-primary btn-greyscale-base no-margin" style="font-size: 2rem;">We have moved to LearnHub.io</a>
                                    </div>
                                </div>
                            </div>
                        </div>
